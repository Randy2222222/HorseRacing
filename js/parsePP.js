...
const STARTING_GATE_LG_REGEX = /^(?:ⁿˢ|ʰᵈ|ⁿᵏ|¼|½|¾|)|((?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{0,2})(?:¼|½|¾|))$/;
//const FIRST_LG_REGEX = /[⁰¹²³⁴⁵⁶⁷⁸⁹]{1,2}/;
//const FIRST_LG_REGEX = /((?:¼|½|¾|)(?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{1,2})(?:¼|½|¾|))/;

//const STARTING_GATE_LENGTHS_REGEX = /[\s\u00A0]*[⁰¹²³⁴⁵⁶⁷⁸⁹](?:¼|½|¾)?/;
const FIRST_CALL_REGEX = /^\d{1,2}$/;
const FIRST_LG_REGEX = /^(?:ⁿˢ|ʰᵈ|ⁿᵏ|¼|½|¾|)|((?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{0,2})(?:¼|½|¾|))$/;
const SECOND_CALL_REGEX = /^\d{1,2}$/;
const SECOND_LG_REGEX = /^(?:ⁿˢ|ʰᵈ|ⁿᵏ|¼|½|¾|)|((?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{0,2})(?:¼|½|¾|))$/;
const STRAIGHT_CALL_REGEX = /^\d{1,2}$/;
const STRAIGHT_LG_REGEX = /^(?:ⁿˢ|ʰᵈ|ⁿᵏ|¼|½|¾|)|((?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{0,2})(?:¼|½|¾|))$/;
const FINISH_REGEX = /^\d{1,2}$/;
const FINISH_LG_REGEX = /^(?:ⁿˢ|ʰᵈ|ⁿᵏ|¼|½|¾|)|((?:[⁰¹²³⁴⁵⁶⁷⁸⁹]{0,2})(?:¼|½|¾|))$/;
